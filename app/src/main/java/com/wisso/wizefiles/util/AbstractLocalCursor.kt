...
abstract class AbstractLocalCursor : Cursor {
    ...
    // Cursor still declares these legacy methods; local cursors must implement them even though
    // modern callers should use close()/requery alternatives instead.
    @Deprecated("Cursor legacy API", level = DeprecationLevel.HIDDEN)

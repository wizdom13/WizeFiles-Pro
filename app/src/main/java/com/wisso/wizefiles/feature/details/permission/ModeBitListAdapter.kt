...
import com.wisso.wizefiles.databinding.ItemModeBitBinding
...
class ModeBitListAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val binding = convertView?.tag as ItemModeBitBinding?
            ?: ItemModeBitBinding.inflate(parent.context.layoutInflater, parent, false)
                .apply { root.tag = this }

...
import com.wisso.wizefiles.databinding.FragmentEditSmbServerBinding
...
class EditSmbServerFragment : Fragment() {
    ...
    private lateinit var binding: FragmentEditSmbServerBinding
    ...
    override fun onCreateView(
        ...
        FragmentEditSmbServerBinding.inflate(inflater, container, false)
            .also { binding = it }
            .root

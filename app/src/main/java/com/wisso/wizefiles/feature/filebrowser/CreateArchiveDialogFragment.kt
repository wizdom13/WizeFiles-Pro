...
import com.wisso.wizefiles.databinding.DialogCreateArchiveBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (savedInstanceState == null) {
            ...
            if (files.size == 1) {
                ...
                val parent = files.mapTo(mutableSetOf()) { it.path.toLegacyPathOrNull()?.parent }.singleOrNull()
    ...
    protected class Binding private constructor(
        ...
        companion object {
            fun inflate(inflater: LayoutInflater): Binding {
                val binding = DialogCreateArchiveBinding.inflate(inflater)

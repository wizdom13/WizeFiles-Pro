...
import com.wisso.wizefiles.core.android.compat.ListFormatterCompat
import com.wisso.wizefiles.databinding.DialogSetModeBinding
...
class SetModeDialogFragment : AppCompatDialogFragment() {
    ...
    private val viewModel by viewModels { { SetModeViewModel(args.mode) } }

    private lateinit var binding: DialogSetModeBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog =
        MaterialAlertDialogBuilder(requireContext(), theme)
            ...
            .apply {
                binding = DialogSetModeBinding.inflate(context.layoutInflater)
                binding.ownerText.setOnClickListener { binding.ownerDropDown.show() }
                val isDirectory = args.isDirectory
    ...
    private fun setMode() {
        ...
        FileOperationService.setMode(path, mode, recursive, uppercaseX, requireContext())
    }
    ...
    companion object {
        ...
        fun show(
            ...
            SetModeDialogFragment().putArgs(Args(file, isDirectory, mode)).show(fragment)
        }
    }

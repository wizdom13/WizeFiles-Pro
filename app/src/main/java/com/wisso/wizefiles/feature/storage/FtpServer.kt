...
import com.wisso.wizefiles.provider.ftp.createFtpRootPath
...
class FtpServer(
    ...
    override fun createEditIntent(): Intent =
        EditFtpServerSettingsActivity::class.createIntent().putArgs(EditFtpServerScreenFragment.Args(this))
}

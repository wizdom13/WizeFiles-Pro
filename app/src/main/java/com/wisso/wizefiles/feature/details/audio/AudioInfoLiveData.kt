...
import com.wisso.wizefiles.core.android.compat.METADATA_KEY_SAMPLERATE
...
class AudioInfoLiveData(path: AppPath) : PathObserverLiveData<Stateful<AudioInfo>>(path) {
    init {
        loadValue()
        observe()
    }

...
import com.wisso.wizefiles.databinding.FragmentEditFtpServerBinding
...
import com.wisso.wizefiles.util.setResult
...
class EditFtpServerScreenFragment : Fragment() {
    private val args by args<Args>()

    private val viewModel by viewModels { { EditFtpServerViewModel() } }

    private lateinit var binding: FragmentEditFtpServerBinding
    ...
    override fun onCreateView(
        ...
        FragmentEditFtpServerBinding.inflate(inflater, container, false)
            .also { binding = it }
            .root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.protocolEdit.setAdapter(
            UnfilteredArrayAdapter(
                binding.protocolEdit.context, R.layout.item_dropdown,
        ...
        binding.modeEdit.setAdapter(
            UnfilteredArrayAdapter(
                binding.modeEdit.context, R.layout.item_dropdown,
        ...
        binding.encodingEdit.setAdapter(
            UnfilteredArrayAdapter(
                binding.encodingEdit.context, R.layout.item_dropdown,

...
import com.wisso.wizefiles.databinding.ItemNavigationDividerBinding
import com.wisso.wizefiles.databinding.ItemNavigationBinding
import com.wisso.wizefiles.ui.AutoMirrorDrawable
...
class NavigationListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (ViewType.entries[viewType]) {
            ViewType.ITEM ->
                ItemHolder(
                    ItemNavigationBinding.inflate(parent.context.layoutInflater, parent, false)
                ).apply {
            ...
            ViewType.DIVIDER ->
                DividerHolder(
                    ItemNavigationDividerBinding.inflate(
    ...
    private class ItemHolder(val binding: ItemNavigationBinding) : RecyclerView.ViewHolder(
        binding.root
    )

    private class DividerHolder(
        val binding: ItemNavigationDividerBinding

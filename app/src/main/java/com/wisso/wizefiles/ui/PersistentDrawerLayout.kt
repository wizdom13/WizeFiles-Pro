    ...
    override fun dispatchApplyWindowInsets(insets: WindowInsets): WindowInsets {
        ...
        for (child in children) {
            if (isDrawerView(child)) {
                val childInsets = if (isLeftDrawerView(child)) {
    ...
    private fun updateContentViewsWindowInsets() {
        ...
        for (child in children) {
            if (isDrawerView(child)) {
                ...
                contentSystemBarsInsets = if (isLeftDrawerView(child)) {
                    Insets.of(
                        (contentSystemBarsInsets.left - childConsumedInset).coerceAtLeast(0),
                        contentSystemBarsInsets.top,
                    ...
                    Insets.of(
                        ...
                        contentSystemBarsInsets.top,
                        (contentSystemBarsInsets.right - childConsumedInset).coerceAtLeast(0),
                        contentSystemBarsInsets.bottom
                    )
                }
            }

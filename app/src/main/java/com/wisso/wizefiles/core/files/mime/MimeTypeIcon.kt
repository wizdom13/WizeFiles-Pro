...
enum class MimeTypeIcon(val resourceId: Int) {
    APK(R.drawable.ic_file_type_apk),
    ARCHIVE(R.drawable.ic_file_type_archive),
    AUDIO(R.drawable.ic_file_type_audio),
    CALENDAR(R.drawable.ic_file_type_calendar),
    CERTIFICATE(R.drawable.ic_file_type_certificate),
    CODE(R.drawable.ic_file_type_code),
    CONTACT(R.drawable.ic_file_type_contact),
    DIRECTORY(R.drawable.ic_file_type_directory),
    DOCUMENT(R.drawable.ic_file_type_document),
    EBOOK(R.drawable.ic_file_type_ebook),
    EMAIL(R.drawable.ic_file_type_email),
    FONT(R.drawable.ic_file_type_font),
    GENERIC(R.drawable.ic_file_type_generic),
    IMAGE(R.drawable.ic_file_type_image),
    PDF(R.drawable.ic_file_type_pdf),
    PRESENTATION(R.drawable.ic_file_type_presentation),
    SPREADSHEET(R.drawable.ic_file_type_spreadsheet),
    TEXT(R.drawable.ic_file_type_text),
    VIDEO(R.drawable.ic_file_type_video),
    WORD(R.drawable.ic_file_type_word),
    EXCEL(R.drawable.ic_file_type_excel),
    POWERPOINT(R.drawable.ic_file_type_powerpoint)
}
...
private val mimeTypeToIconMap = mapOf(
    ...
    "application/x-zstd" to MimeTypeIcon.ARCHIVE,

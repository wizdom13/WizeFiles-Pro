...
class ForegroundTextView : AppCompatTextView, ForegroundViewSupport {
    ...
    constructor(
        ...
        // AppCompatTextView has no defStyleRes constructor; parse our attrs with defStyleRes anyway.
